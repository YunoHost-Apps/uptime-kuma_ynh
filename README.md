...
**Shipped version:** 1.18.2~ynh1 *(:warning: This is the `testing` branch. The [`master` branch](https://github.com/YunoHost-Apps/uptime-kuma_ynh/tree/master) used in the catalog is currently on version 1.18.0\~ynh1.)*
