...
**Shipped version:** 1.18.1~ynh1 *(:warning: This is the `ci-auto-update-v1.18.1` branch. The [`master` branch](https://github.com/YunoHost-Apps/uptime-kuma_ynh/tree/master) used in the catalog is currently on version 1.17.1\~ynh1.)*
