...
**Version incluse :** 1.18.2~ynh1 *(:warning: Il s'agit de la branche `testing`. La [branche `master`](https://github.com/YunoHost-Apps/uptime-kuma_ynh/tree/master) utilisée dans le catalogue est actuellement en 1.18.0\~ynh1.)*
